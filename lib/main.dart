...
import 'package:vsfirstapp/screens/manage_edit_product_screen.dart';
import 'package:vsfirstapp/screens/manage_user_products_screen.dart';
import 'package:vsfirstapp/screens/order_screen.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/manageProductsScreen': (ctx) => ManageUserProductScreen(),
          '/manageEditProductScreen': (ctx) => ManageEditProductScreen(),
        },
      ),
    );
  }
